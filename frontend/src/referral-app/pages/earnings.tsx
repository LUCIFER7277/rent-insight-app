      ...
      <div className="p-4 md:p-6 max-w-3xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-card border border-border rounded-2xl p-4">
            ...
            <p className="text-xs text-muted-foreground mt-1">{dashboard.referrer.verifiedReferrals} leads Ã— ₹50</p>
          </div>
          <div className="bg-card border border-border rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs text-muted-foreground mt-1">{dashboard.referrer.bookedReferrals} bookings Ã— ₹500</p>
          </div>
          <div className="bg-card border border-border rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-2">
