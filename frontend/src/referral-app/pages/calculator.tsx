          ...
          <motion.div key={`${referrals}-${verifyRate}-${bookRate}`} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-orange-50 border border-orange-100 rounded-2xl p-5">
                ...
                <p className="text-sm text-orange-600 mt-1">4 weeks Ã— ₹{data.totalEarnings.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-5">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-slate-600 text-sm">Verification bonus (₹50 Ã— {data.verifiedCount})</span>
                  <span className="font-bold text-slate-800">₹{data.verificationEarnings}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-600 text-sm">Booking bonus (₹500 Ã— {data.bookedCount})</span>
