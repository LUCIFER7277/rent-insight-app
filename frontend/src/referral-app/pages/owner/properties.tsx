...
import { useGetRealOwnerProperties, useUpdatePropertyAvailability } from "@/referral-app/api";
...
export default function OwnerPropertiesPage() {
  ...
  const { isOwnerAuthenticated, ownerToken, ownerUser } = useOwnerStore();
  ...
  const { data: properties, isLoading, refetch } = useGetRealOwnerProperties(ownerToken);
