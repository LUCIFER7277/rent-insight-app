...
const PERSONA_LABELS: Record<string, { emoji: string; label: string; color: string; bg: string }> = {
  GUARD:        { emoji: "ðŸ›¡ï¸", label: "Daily Worker",   color: "text-zinc-700",   bg: "from-zinc-800 to-zinc-900" },
  STUDENT:      { emoji: "ðŸŽ“", label: "College Student", color: "text-orange-700", bg: "from-orange-400 to-orange-600" },
  EARNER:       { emoji: "ðŸ’¼", label: "Side Hustler",    color: "text-blue-700",   bg: "from-blue-500 to-blue-700" },
  PG_MANAGER:   { emoji: "ðŸ ", label: "PG Manager",      color: "text-teal-700",   bg: "from-teal-500 to-teal-700" },
  BROKER:       { emoji: "ðŸ¤", label: "Broker / Agent",  color: "text-slate-700",  bg: "from-slate-700 to-slate-900" },
  INFLUENCER:   { emoji: "ðŸ“±", label: "Influencer",      color: "text-purple-700", bg: "from-purple-500 to-purple-700" },
  CORPORATE_HR: { emoji: "ðŸ¢", label: "Corporate HR",    color: "text-indigo-700", bg: "from-indigo-500 to-indigo-700" },
};
    ...
    <div className="min-h-[100dvh] bg-[#FBFBFC]">
      ...
      <div className="px-4 pt-6 pb-12 max-w-sm mx-auto space-y-5">
        ...
        {conversionRate > 0 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }}
            ...
            <div>
              ...
              <p className="text-green-600 text-xs">{referrer.verifiedReferrals} leads verified Â· {referrer.bookedReferrals} booked</p>
            </div>
          </motion.div>
        )}
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-orange-700 text-sm mt-1">
                {referrer.name.split(" ")[0]} will help you find verified, affordable PGs in top areas Â· Koramangala, HSR, Indiranagar & more.
              </p>
            </div>
          </div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
          ...
          <h3 className="font-black text-xl mb-1">Earn â‚¹500 per booking</h3>
        ...
        <p className="text-center text-xs text-slate-400">
          Powered by <span className="font-bold text-orange-500">Gharpayy</span> Â· PG Referral Platform, Bangalore
        </p>
